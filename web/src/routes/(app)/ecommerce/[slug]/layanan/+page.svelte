...
<div class="max-w-7xl mx-auto space-y-6 py-4 px-4 mt-6" in:fade>
    ...
    <div class="flex items-center gap-6">
      <div>
        <div class="flex items-center gap-2 mb-0.5">
          ...
          <h2 class="text-[9px] font-black text-indigo-600 uppercase tracking-widest leading-none">Layanan Pelanggan</h2>
        </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4">
    {#each entitasTerfilter as unit}
      ...
      <a 
        id="unit-{unit.id}" 
        href={`/ecommerce/${unit.slug}/layanan`} 
      ...
      >
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="flex items-center gap-1.5 mt-1">
              ...
              <p class="text-[8px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest leading-none">Status: Permanent</p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-4 pt-3 border-t border-slate-50 dark:border-slate-800 flex justify-between items-center">
          ...
          <div class="flex items-center gap-1 text-slate-300 group-hover:text-indigo-600 transition-colors">
            <span class="text-[8px] font-black uppercase">Buka CS</span>
    ...
    <div class="bg-white dark:bg-slate-800 w-full max-w-sm rounded-md shadow-lg border border-slate-200 dark:border-slate-700">
      ...
      <div class="p-4 space-y-3">
        <div class="space-y-1">
          ...
          <a href={`/ecommerce/${indukTerpilih.slug}/layanan`} class="flex items-center justify-between p-3 bg-slate-900 text-white rounded-md hover:bg-black transition-colors">
        ...
        <div class="pt-2">
          ...
          <div class="max-h-[220px] overflow-y-auto space-y-1 pr-1 custom-scroll">
            {#each daftarCabang as cabang}
              <a href={`/ecommerce/${cabang.slug}/layanan`} class="flex items-center justify-between p-3 border border-slate-100 dark:border-slate-800 rounded-md text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:bg-slate-900 transition-all group">
